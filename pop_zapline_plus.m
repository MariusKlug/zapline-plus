...
if nargin < 2
        ...
        { 'style'  'checkbox'   'string' 'Plot results' 'value' 0 'tag' 'plot' } ...
    ...
    geometry = {[2 0.5] [1] [1] [1] [2 0.5] };
    
    [~,~,~,res] = inputgui( 'geometry', geometry, 'geomvert', [1 1 1 1 1], 'uilist', promptstr, 'helpcom', 'pophelp(''pop_zapline_plus'')', 'title', 'Process data with Zapline-plus');
